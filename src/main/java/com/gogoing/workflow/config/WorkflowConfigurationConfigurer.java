...
public class WorkflowConfigurationConfigurer implements ProcessEngineConfigurationConfigurer {
    ...
    public void configure(SpringProcessEngineConfiguration processEngineConfiguration) {
        ...
        processEngineConfiguration.setIdentityLinkEntityManager(
            new CustomIdentityLinkEntityManagerImpl(processEngineConfiguration, processEngineConfiguration.getIdentityLinkDataManager())
        );
