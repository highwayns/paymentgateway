...
public class BpmnUtil {
     ...
     * @return
     */
    public static FlowElement querySubmitNextTask(
        FlowElement targetFlowElement,
        ExecutionEntityImpl execution,
        List<FlowElement> flowElement
    ) {
     ...
     * @return
     */
    public static Map<String, List<SequenceFlow>> invokeSequenceFlows(
        BpmnModel bpmnModel,
        List<Task> taskList,
        FlowElement targetFlowElement
    ) {
