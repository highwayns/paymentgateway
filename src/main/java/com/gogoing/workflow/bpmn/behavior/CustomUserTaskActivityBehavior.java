package com.gogoing.workflow.bpmn.behavior;
...
public class CustomUserTaskActivityBehavior extends UserTaskActivityBehavior {
    ...
    protected CustomUserTask userTask;

    public CustomUserTaskActivityBehavior(CustomUserTask userTask) {
        super(userTask);
    ...
    public void execute(DelegateExecution execution) {
        ...
        List<String> activeTaskCandidateNotifyUsers = null;
        ...
        if (Context.getProcessEngineConfiguration().isEnableProcessDefinitionInfoCache()) {
            ...
            activeTaskDescription =
                getActiveValue(userTask.getDocumentation(), DynamicBpmnConstants.USER_TASK_DESCRIPTION, taskElementProperties);
            ...
            activeTaskSkipExpression =
                getActiveValue(userTask.getSkipExpression(), DynamicBpmnConstants.TASK_SKIP_EXPRESSION, taskElementProperties);
            ...
            activeTaskCandidateUsers =
                getActiveValueList(userTask.getCandidateUsers(), DynamicBpmnConstants.USER_TASK_CANDIDATE_USERS, taskElementProperties);
            activeTaskCandidateGroups =
                getActiveValueList(userTask.getCandidateGroups(), DynamicBpmnConstants.USER_TASK_CANDIDATE_GROUPS, taskElementProperties);
        } else {
            ...
            activeTaskCandidateNotifyUsers = userTask.getCandidateNotifyUsers();
        }
                ...
                if (dueDate instanceof Date) {
                    ...
                    if (StringUtils.isNotEmpty(userTask.getBusinessCalendarName())) {
                        businessCalendarName =
                            expressionManager.createExpression(userTask.getBusinessCalendarName()).getValue(execution).toString();
                    } else {
        ...
        if (!skipUserTask) {
            handleAssignments(
                ...
                activeTaskCandidateUsers,
                activeTaskCandidateGroups,
                activeTaskCandidateNotifyUsers,
                task,
                expressionManager,
                execution
            );
    ...
    protected void handleAssignments(
        ...
        List<String> candidateNotifyUsers,
        TaskEntity task,
                ...
                if (value instanceof String) {
                    ...
                    for (String userId : userIds) {
                        Context
                            ...
                            .addUserIdentityLink(task, userId, ProcessConstants.NOTIFY);
                    }
                } else if (value instanceof Collection) {
                    ...
                    while (userIdSet.hasNext()) {
                        Context
                            .getCommandContext()
                            .getIdentityLinkEntityManager()
                            .addUserIdentityLink(task, (String) userIdSet.next(), ProcessConstants.NOTIFY);
                    }
                    throw new ActivitiException("Expression did not resolve to a string or collection of strings");
                }
            }
