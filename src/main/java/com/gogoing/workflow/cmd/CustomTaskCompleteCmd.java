...
public class CustomTaskCompleteCmd extends CompleteTaskCmd {
    ...
    public CustomTaskCompleteCmd(
        String taskId,
        Map<String, Object> variables,
        Map<String, Object> transientVariables,
        boolean eventDispatcher
    ) {
    ...
    protected void executeTaskComplete(
        ...
        if (Authentication.getAuthenticatedUserId() != null && taskEntity.getProcessInstanceId() != null) {
            ...
            commandContext
                ...
                .involveUser(processInstanceEntity, Authentication.getAuthenticatedUserId(), IdentityLinkType.PARTICIPANT);
        }
        if (!eventDispatcher) {
