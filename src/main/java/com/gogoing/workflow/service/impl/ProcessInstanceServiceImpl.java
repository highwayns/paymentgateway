...
public class ProcessInstanceServiceImpl implements ProcessInstanceService {
    ...
    public ProcessStartResult startProcInstanceByKey(ProcessStartParam startProcessParam) {
        ...
        ProcessInstance oldProcessInstance = runtimeService
    ...
    public Boolean processReturn(ProcessReturnParam processReturnParam) {
        ...
        ProcessInstance processInstance = processEngine
            ...
            .processDefinitionKey(processReturnParam.getProcessDefineKey())
            .singleResult();
        ...
        ExecutionEntityImpl execution = (ExecutionEntityImpl) runtimeService
    ...
    public Boolean procInstanceDelete(ProcInstanceDeleteParam deleteProcInstanceParam) {
        ...
        ProcessInstance processInstance = processInstanceQuery.startedBy(deleteProcInstanceParam.getUserId()).singleResult();
        if (processInstance == null) {
        ...
        List<Task> list = taskList
            .stream()
            .filter(item -> !item.getTaskDefinitionKey().equals(targetFlowElement.getId()))
    ...
    private String handleAssignee(String taskId) {
        ...
        if (CollectionUtil.isNotEmpty(identityLinksForTask)) {
            List<String> candidateUsersList = identityLinksForTask
                .stream()
                .filter(item -> StringUtil.isNotEmpty(item.getUserId()))
