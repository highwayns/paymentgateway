...
public class ProcessTaskServiceImpl implements ProcessTaskService {
    ...
    public PageBean<ProcessTaskResult> queryUnFinishTask(TaskUnFinishQuery taskUnFinishQuery) {
        ...
        Long count = managementService.executeCustomSql(
            new AbstractCustomSqlExecution<CustomActivitiDatabaseMapper, Long>(CustomActivitiDatabaseMapper.class) {
                @Override
        ...
        List<ProcessTaskResult> list = managementService.executeCustomSql(
            new AbstractCustomSqlExecution<CustomActivitiDatabaseMapper, List<ProcessTaskResult>>(CustomActivitiDatabaseMapper.class) {
                @Override
